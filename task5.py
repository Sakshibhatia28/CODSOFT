...
def remove_existing(pb):
	...
	query = str(
		input("Please enter the name of the contact you wish to delete: "))
...
def search_existing(pb):
	...
	# This will execute for searches based on contact''s date of birth
		query = str(input("Please enter the addressof the contact you wish to search: "))
		for  i in range(len(pb)):
			if query == pb[i][3]:
				check = i
				temp.append(pb[i])
...
# Main function code
print("....................................................................")
print("Hello dear user, welcome to our contact book ")
